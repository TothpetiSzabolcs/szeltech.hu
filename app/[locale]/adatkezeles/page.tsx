  ...
  return (
    <main className="min-h-screen bg-bg pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6 lg:px-16">
        ...
        <p className="text-sm text-steel-dark/60 mb-12">{t("last_updated")}: 2026.02.17</p>
        ...
        <div className="prose prose-invert max-w-none space-y-10">
          ...
          <section>
            ...
            <div className="bg-bg-2 border border-white/5 p-6 rounded space-y-2">
              <p className="text-steel-dark"><strong>Név:</strong> Szélig Zoltán Egyéni Vállalkozó</p>
